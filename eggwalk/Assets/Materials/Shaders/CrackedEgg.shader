...
/////// Diffuse:
                ...
                float3 diffuseColor = (_ColorOverlay.rgb+(_Diffuse_var.rgb*Function_node_4211( _CrackingLevel , float3(1,1,1) , (1.0 - _MaskLevel1_var.rgb) , (1.0 - _MaskLevel2_var.rgb) , (1.0 - _MaskLevel3_var.rgb) )));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _MaskLevel2_var = tex2D(_MaskLevel2,TRANSFORM_TEX(i.uv0, _MaskLevel2));
                float4 _MaskLevel3_var = tex2D(_MaskLevel3,TRANSFORM_TEX(i.uv0, _MaskLevel3));
                float3 diffColor = (_ColorOverlay.rgb+(_Diffuse_var.rgb*Function_node_4211( _CrackingLevel , float3(1,1,1) , (1.0 - _MaskLevel1_var.rgb) , (1.0 - _MaskLevel2_var.rgb) , (1.0 - _MaskLevel3_var.rgb) )));
